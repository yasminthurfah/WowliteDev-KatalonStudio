...
WebUI.check(findTestObject('Media/CheckAllMedia'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('10 Selected', false)

WebUI.delay(5)

WebUI.uncheck(findTestObject('Media/CheckAllMedia'))

WebUI.verifyTextPresent('0 Selected', false)
