...
//login with username and password true
WebUI.openBrowser('')
...
WebUI.click(findTestObject('Object Repository/Dashboard/img_profileimage'))

WebUI.click(findTestObject('Object Repository/Dashboard/div_Log Out'))

WebUI.verifyElementPresent(findTestObject('Login/Page_PixelPop  Log in/lbl_Welcome'), 0)
