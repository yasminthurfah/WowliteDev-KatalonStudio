...
//login with false email, true password
WebUI.openBrowser('')

WebUI.navigateToUrl('https://wowlite.interadsdev.com/login')

WebUI.setText(findTestObject('Login/Page_PixelPop  Log in/tb_email'), 'hananurul@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Login/Page_PixelPop  Log in/pop_loginfailed'), 0)
