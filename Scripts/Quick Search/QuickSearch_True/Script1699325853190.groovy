...
WebUI.click(findTestObject('Quick Search/btn_QuickSearch'))

WebUI.setText(findTestObject('Quick Search/tb_QuickSearch'), 'Floridina')

WebUI.verifyTextPresent('Media', false)

WebUI.delay(2)

WebUI.verifyTextPresent('Great to see you!', false)
